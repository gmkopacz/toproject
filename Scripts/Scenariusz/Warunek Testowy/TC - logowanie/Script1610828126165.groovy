...
for(def row = 1; row <= findTestData('Logowanie_demoblaze').getRowNumbers(); row++)
{
	WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Username_loginusername'), 
		findTestData('Logowanie_demoblaze').getValue('username', row))
	
	WebUI.setText(findTestObject('Object Repository/Page_STORE/input_Password_loginpassword'), 
		findTestData('Logowanie_demoblaze').getValue('password', row))
